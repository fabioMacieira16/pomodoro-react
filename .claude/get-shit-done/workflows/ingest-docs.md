...
```bash
INIT=$(node "C:/Projetos/pomodoro-react/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Projetos/pomodoro-react/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
