...
```markdown
Read C:/Projetos/pomodoro-react/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Projetos/pomodoro-react/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Projetos/pomodoro-react/.claude/agents/gsd-ui-checker.md for instructions.
