...
```bash
INIT=$(node "C:/Projetos/pomodoro-react/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Projetos/pomodoro-react/.claude/get-shit-done/templates/spec.md.
