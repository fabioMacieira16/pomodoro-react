...
```
Agent(
  prompt="Read C:/Projetos/pomodoro-react/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Projetos/pomodoro-react/.claude/get-shit-done/templates/VALIDATION.md`
