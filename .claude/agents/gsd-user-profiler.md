...
<reference>
@C:/Projetos/pomodoro-react/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Projetos/pomodoro-react/.claude/get-shit-done/references/user-profiling.md` to load:
