...
Use template from `C:/Projetos/pomodoro-react/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Projetos/pomodoro-react/.claude/get-shit-done/templates/UI-SPEC.md`
