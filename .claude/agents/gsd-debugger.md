...
<required_reading>
@C:/Projetos/pomodoro-react/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Projetos/pomodoro-react/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Projetos/pomodoro-react/.claude
                  → checks C:/Projetos/pomodoro-react/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Projetos/pomodoro-react/.claude/get-shit-done
                  → writes to C:/Projetos/pomodoro-react/.claude/get-shit-done/hooks/
...
@C:/Projetos/pomodoro-react/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Projetos/pomodoro-react/.claude/get-shit-done/references/common-bug-patterns.md
