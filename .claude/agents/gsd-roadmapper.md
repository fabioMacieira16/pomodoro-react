...
Reference full template: `C:/Projetos/pomodoro-react/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Projetos/pomodoro-react/.claude/get-shit-done/templates/state.md`.
